...
class CustomFoodHubIcon extends StatelessWidget {
  const CustomFoodHubIcon({super.key});
  ...
  Widget build(BuildContext context) {
    return Center(
      ...
      <filter id="filter0_d_814_7048" x="0" y="0" width="163" height="163" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        ...
        <feColorMatrix type="matrix" values="0 0 0 0 0.858333 0 0 0 0 0.284504 0 0 0 0 0.12875 0 0 0 0.5 0"/>
