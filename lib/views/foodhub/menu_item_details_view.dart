...
import 'package:foodhub/views/foodhub/add_on_list_view.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            StreamBuilder(
              stream: _cloudServices.getMenuAddOns(menuName: menuItem.name),
              builder: (context, snapshot) {
                switch (snapshot.connectionState) {
                  case ConnectionState.waiting:
                  case ConnectionState.active:
                    if (snapshot.hasData) {
                      final addOns = snapshot.data as List<AddOn>;
                      return SingleChildScrollView(
                        child: Container(
                          ...
                          child: AddOnListView(
                            addOns: addOns,
                            onAddOnSelected: (int selectedInt) {
                              setState(() {
                                selectedAddOn = addOns[selectedInt];
                              });
                            },
                          ),
                        ),
            ...
            const Center(child: CustomCartButton()),
          ],
        ),
      ),
    );
