...
typedef IsPopularFoodItemFavouriteCallback = Stream<bool> Function(
  MenuItem menuItem,
);

class PopularItemListView extends StatefulWidget {
  final List<MenuItem> menuItems;
  final PopularMenuItemCallback onTap;
  final PopularMenuItemCallback addToFavourite;
  final IsPopularFoodItemFavouriteCallback isFavourite;
  ...
  @override
  State<PopularItemListView> createState() => _PopularItemListViewState();
}
